...
**Reason**: A criação de transação passa a ser iniciada no hero de Meu mês via Drawer; o botão global do header foi removido.
**Migration**: Usar o botão “Nova transação” em `/meu-mes`.
